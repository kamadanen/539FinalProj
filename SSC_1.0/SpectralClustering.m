...
kerNS = bsxfun(@rdivide, kerN, normN + eps); % Normalizing the rows to norm 1
groups = kmeans(kerNS,n,'maxiter',MAXiter,...
    'replicates',REPlic,'EmptyAction','singleton'); % Performing kmeans along rows
